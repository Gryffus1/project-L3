  ...
  renderWin(render, score = 0, savedScores = []) {
    ...
    if (render) {
      ...
      markupParts.push(`
        ...
        <img style="display: flex;justify-content: center; width: 200px; height: 200px;"  src="/images/images manchots/Gainmanchot.gif" />
        <p class="win-score">Votre score est ${score}</p>
